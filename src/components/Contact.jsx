      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          ...
          <div className="flex mx-3">
            <a href="https://github.com/miriammildred" target="_blank" rel="noreferrer">
              <img src={github} alt="" />
            </a>
            <a className="" href="https://www.linkedin.com/in/miriam-akinyie-aa749818b" target="_blank" rel="noreferrer">
              <img src={linkedin} alt="" />
            </a>
            <a href="https://twitter.com/justmildredo" target="_blank" rel="noreferrer">
              <img src={twitter} alt="" />
            </a>
            {/* <a href="https://web.facebook.com/miriamakinyi/" target="_blank" rel="noreferrer">
